; ModuleID = 'tests/secure_rule_logging.c'
source_filename = "tests/secure_rule_logging.c"
...
@.str.1 = private unnamed_addr constant [23 x i8] c"installing version %d\0A\00", align 1
